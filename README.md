...
<div align="center">
  <img src="docs/images/profile_demo.png" alt="zd.profile() output showing dataset overview, data quality score, and column statistics table" width="780"/>
  <br/>
...
<div align="center">
  <img src="docs/images/ml_ready_demo.png" alt="zd.ml_ready() output showing ML Readiness score, warnings per column, and suggested next step code" width="780"/>
  <br/>
...
<div align="center">
  <img src="docs/images/compare_demo.png" alt="zd.compare() and zd.warnings() output showing new categories detected and all smart warnings" width="780"/>
  <br/>
